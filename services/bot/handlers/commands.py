...
async def cmd_yordam(update:Update, ctx:ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "/foyda — Foyda tahlili\n\n"
        "🧠 *AI va Analytics:*\n"
        "/tahlil — AI biznes maslahat\n"
        "/kpi — Samaradorlik ko'rsatkichlari\n"
        "/prognoz — 🔮 AI talab prognozi\n"
        "/clv — 💎 Klient qiymati\n"
        "/segment — 🎯 Klient segmentatsiya\n"
        "/buyurtma — Tovar buyurtma tavsiyasi\n\n"
        "💰 *Moliya:*\n"
        "/eslatma — Qarz eslatma yuborish\n"
        "/loyalty — Bonus ball tekshirish\n"
        "/tariflar — Tarif planlari\n\n"
        "🗺 *Monitoring:*\n"
        "/marshrut — GPS kunlik marshrut\n"
        "/kassa — Kassa holati\n"
