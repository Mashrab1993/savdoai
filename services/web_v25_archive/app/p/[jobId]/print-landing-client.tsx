  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-6 p-6 bg-zinc-950 text-zinc-100">
      ...
      {token ? (
        <a
          href={appUrl}
          className="rounded-xl bg-primary hover:bg-primary/90 active:bg-primary/80 px-8 py-4 text-lg font-semibold text-white text-center shadow-lg w-full max-w-sm"
        >
