          ...
          <div key={ci}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {cat.items.map((item, i) => (
                <Link key={i} href={item.href} className="bg-card/60 backdrop-blur-xl border border-border/60 rounded-2xl p-4 hover:shadow-md hover:border-emerald-500/40 transition group">
