...
export default function ReportsPage() {
  ...
  const kpiCards = [
    ...
    { label: L.totalProducts[locale], value: String(totalInvoices), icon: Package,    color: "text-amber-500"   },
    { label: L.avgOrder[locale],      value: fmt(totalDebt),        icon: TrendingUp, color: "text-emerald-500"    },
  ]
