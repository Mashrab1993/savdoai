    ...
    <AdminLayout>
      <div className="max-w-[1300px] mx-auto space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Anomaliya</h1>
        ...
        <Card className="p-6 bg-gradient-to-br from-purple-50 to-blue-50 border-purple-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-purple-900">AI Anomaliya</h3>
        ...
        {!loading && (!Array.isArray(items) || items.length === 0) && isAuthenticated && (
          <Card className="p-8 text-center text-slate-500">
            Hozircha Anomaliya topilmadi. <Link href="/ai/copilot" className="text-emerald-700 underline">AI Copilot</Link> orqali so'rang.
          </Card>
        )}
      </div>
    </AdminLayout>
