    ...
    <AdminLayout>
      <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
          {BONUS_TYPES.map(t => (
            <div key={t.key} className="bg-white dark:bg-gray-900 rounded-xl border p-4 hover:border-emerald-300 cursor-pointer transition" onClick={() => { setForm({ ...form, turi: t.key }); setShowAdd(true) }}>
