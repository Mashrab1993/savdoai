      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { label: L.activeStaff[locale],  value: String(activeCount),         icon: GraduationCap, color: "text-emerald-500", bg: "bg-emerald-500/15 dark:bg-emerald-950/20" },
            { label: L.monthlyBudget[locale], value: fmt(totalMonthlySales),    icon: Wallet,      color: "text-violet-500", bg: "bg-secondary" },
            { label: L.todayExpenses[locale], value: fmt(totalTodaySales),       icon: TrendingUp,  color: "text-amber-500", bg: "bg-amber-500/15 dark:bg-amber-950/20" },
          ].map(s => (
