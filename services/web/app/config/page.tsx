  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6">
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        {/* Sozlamalar paneli */}
        <div className="flex-1 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">{currentModul?.tavsif}</p>
            </div>
            <button
              onClick={handleSave}
              disabled={saving}
          ...
          <div className="space-y-3">
            {currentModul?.fieldlar.map(f => (
              <div key={f.key} className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-800 last:border-0">
                ...
                {f.type === "number" && (
                  <input
                    ...
                    className="w-28 px-3 py-1.5 text-sm border rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 text-right"
                  />
                )}
