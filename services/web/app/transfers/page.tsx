...
const HOLAT_META: Record<string, { label: string; color: string }> = {
  kutilmoqda:   { label: "Kutilmoqda", color: "bg-yellow-100 text-yellow-800" },
  tasdiqlangan: { label: "Tasdiqlangan", color: "bg-emerald-100 text-emerald-800" },
  bekor:        { label: "Bekor",      color: "bg-red-100 text-red-800" },
}
