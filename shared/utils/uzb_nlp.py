...
SHEVA_NORMALIZATSIYA: list[tuple[str, str]] = [
    ...
    # ── TOJIK TILI ─────────────────────────────────────────
    # Kirill versiya (grafik_norm dan OLDIN)
    (r"\bяк\b",           "bir"),
    (r"\bду\b",           "ikki"),
    (r"\bсе\b",           "uch"),
    (r"\bчор\b",          "to'rt"),
    (r"\bпанҷ\b",         "besh"),       (r"\bпанж\b", "besh"),
    (r"\bшаш\b",          "olti"),
    (r"\bҳафт\b",         "yetti"),      (r"\bхафт\b", "yetti"),
    (r"\bҳашт\b",         "sakkiz"),     (r"\bхашт\b", "sakkiz"),
    (r"\bнуҳ\b",          "to'qqiz"),    (r"\bнух\b", "to'qqiz"),
    (r"\bдаҳ\b",          "o'n"),        (r"\bдах\b", "o'n"),
    (r"\bбист\b",         "yigirma"),
    (r"\bсӣ\b",           "o'ttiz"),
    (r"\bчил\b",          "qirq"),
    (r"\bпанҷоҳ\b",       "ellik"),      (r"\bпанжох\b", "ellik"),
    (r"\bшаст\b",         "oltmish"),
    (r"\bҳафтод\b",       "yetmish"),    (r"\bхафтод\b", "yetmish"),
    (r"\bнавад\b",        "to'qson"),
    (r"\bсад\b",          "yuz"),
    (r"\bҳазор\b",        "ming"),       (r"\bхазор\b", "ming"),
    # Amallar (kirill)
    (r"\bфурохт\b",       "sotdi"),
    (r"\bдодам\b",        "berdim"),
    (r"\bомад\b",         "keldi"),
    (r"\bовардам\b",      "keltirdim"),
    (r"\bгирифтам\b",     "oldim"),
    (r"\bчанд\b",         "qancha"),
    (r"\bпул\b",          "pul"),
    # Lotin versiya (grafik_norm dan KEYIN)
    (r"\byak\b",          "bir"),
    (r"\bdu\b",           "ikki"),
    (r"\bse\b",           "uch"),
    (r"\bchor\b",         "to'rt"),
...
AMAL_MAP: dict[str, str] = {
    ...
    # ── TOJIK TILI ───────────────────────────────────────
    "фурохтам":    "chiqim",   "фурохт":     "chiqim",    # sotdim
    "додам":       "chiqim",   "дод":        "chiqim",    # berdim
    "рафт":        "chiqim",                               # ketti
    "омад":        "kirim",    "овардам":    "kirim",     # keldi, keltirdim
    "гирифтам":    "kirim",                                # oldim
    "баргардонд":  "qaytarish",                            # qaytardi
    "пардохт":     "qarz_tolash", "пардохтам": "qarz_tolash",  # to'ladi
}
